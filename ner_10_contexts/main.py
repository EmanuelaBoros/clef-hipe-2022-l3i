...
#                  word_dropout=0.01)
        embed_french = BertEmbedding(data.get_vocab('words'), model_dir_or_name='bert-base-multilingual-cased', #args.pre_trained_model, #Davlan/bert-base-multilingual-cased-ner-hrl", #args.pre_trained_model,
                    pool_method='last', requires_grad=True, layers='0,-1,-2,-3,-4,-5', 
                    include_cls_sep=False, dropout=0.2, auto_truncate=True,
                  word_dropout=0.01)
...
#        embed_ner_french = CamembertEmbedding(data.get_vocab('words'), model_dir_or_name="Jean-Baptiste/camembert-ner", #fhswf/bert_de_ner", #Jean-Baptiste/camembert-ner",
#                    pool_method='last', requires_grad=True, layers='0,-1,-2,-3,-4,-5', 
#                    include_cls_sep=False, dropout=0.2, auto_truncate=True,
#                  word_dropout=0.01)
#        
